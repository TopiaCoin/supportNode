...
public class MicroNetworkInfoSqliteDataModelProviderTest extends AbstractMicroNetworkInfoDataModelProviderTest {

    private DataModel _dataModel;
    private SQLiteDataModelProvider _sqliteDataModelProvider;
    private String _databasePath = "target" ;
    private String _databaseName = "microNetworkTest.sqlite";
