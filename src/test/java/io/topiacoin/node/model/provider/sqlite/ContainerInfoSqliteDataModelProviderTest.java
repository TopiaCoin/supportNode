...
public class ContainerInfoSqliteDataModelProviderTest extends AbstractContainerInfoDataModelProviderTest {

    private DataModel _dataModel;
    private SQLiteDataModelProvider _sqliteDataModelProvider;
    private String _databasePath = "target" ;
    private String _databaseName = "containerTest.sqlite";
