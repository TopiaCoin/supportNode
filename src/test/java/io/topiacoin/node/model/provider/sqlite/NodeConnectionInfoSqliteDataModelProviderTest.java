...
public class NodeConnectionInfoSqliteDataModelProviderTest extends AbstractNodeConnectionInfoDataModelProviderTest {

    private DataModel _dataModel;
    private SQLiteDataModelProvider _sqliteDataModelProvider;
    private String _databasePath = "target" ;
    private String _databaseName = "nodeConnectionTest.sqlite";
