...
@ResponseStatus(value=HttpStatus.CONFLICT, reason = "The specified data item already exists")
public class DataItemAlreadyExistsException extends Exception {
    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     */
    public DataItemAlreadyExistsException() {
    }
     ...
     *                method.
     */
    public DataItemAlreadyExistsException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public DataItemAlreadyExistsException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public DataItemAlreadyExistsException(Throwable cause) {
        super(cause);
    }
}
