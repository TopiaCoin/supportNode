...
public class FailedToRemoveContainer extends Exception {
    /**
     ...
     */
    public FailedToRemoveContainer() {
    }
     ...
     *                method.
     */
    public FailedToRemoveContainer(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public FailedToRemoveContainer(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public FailedToRemoveContainer(Throwable cause) {
        super(cause);
    }
}
