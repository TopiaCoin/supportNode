...
public class FailedToReplicateContainer extends Exception {
    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     */
    public FailedToReplicateContainer() {
    }
     ...
     *                method.
     */
    public FailedToReplicateContainer(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public FailedToReplicateContainer(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public FailedToReplicateContainer(Throwable cause) {
        super(cause);
    }
}
