...
public class NoSuchMicroNetworkException extends Exception {
     ...
     */
    public NoSuchMicroNetworkException() {
    }
     ...
     *                method.
     */
    public NoSuchMicroNetworkException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public NoSuchMicroNetworkException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public NoSuchMicroNetworkException(Throwable cause) {
        super(cause);
    }
}
