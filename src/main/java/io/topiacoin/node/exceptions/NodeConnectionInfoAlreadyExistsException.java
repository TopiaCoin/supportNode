...
public class NodeConnectionInfoAlreadyExistsException extends Exception {
    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     */
    public NodeConnectionInfoAlreadyExistsException() {
    }
     ...
     *                method.
     */
    public NodeConnectionInfoAlreadyExistsException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public NodeConnectionInfoAlreadyExistsException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public NodeConnectionInfoAlreadyExistsException(Throwable cause) {
        super(cause);
    }
}
