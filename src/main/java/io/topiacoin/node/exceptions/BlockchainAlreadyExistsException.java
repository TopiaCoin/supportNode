...
public class BlockchainAlreadyExistsException extends Exception {
     ...
     */
    public BlockchainAlreadyExistsException() {
    }
     ...
     *                method.
     */
    public BlockchainAlreadyExistsException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public BlockchainAlreadyExistsException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public BlockchainAlreadyExistsException(Throwable cause) {
        super(cause);
    }
}
