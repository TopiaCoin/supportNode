...
public class NoSuchBlockchainException extends Exception {
    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     */
    public NoSuchBlockchainException() {
    }
     ...
     *                method.
     */
    public NoSuchBlockchainException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public NoSuchBlockchainException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public NoSuchBlockchainException(Throwable cause) {
        super(cause);
    }
}
