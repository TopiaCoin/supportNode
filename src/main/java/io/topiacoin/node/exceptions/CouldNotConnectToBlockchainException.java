...
public class CouldNotConnectToBlockchainException extends Exception {
    /**
     ...
     *                method.
     */
    public CouldNotConnectToBlockchainException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public CouldNotConnectToBlockchainException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public CouldNotConnectToBlockchainException(Throwable cause) {
        super(cause);
    }
}
