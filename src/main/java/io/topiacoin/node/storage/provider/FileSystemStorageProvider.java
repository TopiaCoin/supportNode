...
public class FileSystemStorageProvider implements DataStorageProvider {
     ...
     */
    @Override
    public void fetchData(String dataID, OutputStream outputStream) throws IOException {
     ...
     */
    @Override
    public void fetchData(String dataID, int offset, int length, OutputStream outputStream) throws IOException {
